...
storiesOf("Appointment", module)
  ...
  .add("Form Edit", () => <Form student="Eric Solomon" interviewer={1} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")}/>)
